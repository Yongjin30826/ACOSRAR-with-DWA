...
%     lighting gouraud;                % Use decent lighting.
    ...
    for i = 1:threat_num
        ...
        plot3(threat_x, threat_y, threat_z, 'o', 'color', [0.5, 0, 0.5], 'MarkerSize', 3, 'MarkerFaceColor','#752e29');
    ...
    % plot start point
    plot3(x_all(1),y_all(1),z_all(1),'ks','MarkerSize',10,'MarkerFaceColor','k');

    % plot target point
    plot3(x_all(N),y_all(N),z_all(N),'ko','MarkerSize',10,'MarkerFaceColor','k');
